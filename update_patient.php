...
`course`, date_format(`date_of_birth`, '%m/%d/%Y') as `date_of_birth`,  `phone_number`, `gender`,`visit`,`medicine`,`disease`
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    ...
                                    <select class="form-control form-control-sm rounded-0" id="course" name="course">
                                        <option value="<?php echo $row['course'];?>" selected>Selected
                                            Course <?php echo $row['course'];?></option>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="date">
                                            <input type="date" value="<?php echo $row['visit'];?>"
                                                class="form-control form-control-sm rounded-0 datetimepicker-input"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Disease</label>
                                    <input type="text" id="patient_name" value="<?php echo $row['disease'];?>"
                                        name="disease" required="required"
                                        class="form-control form-control-sm rounded-0" />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
