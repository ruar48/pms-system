...
function getCourse222() {
	//do not use this function
	exit;
	$data = '<option value="">Select Course</option>';

	$data = $data .'<option value="BSIS">BSIS</option>';
	$data = $data .'<option value="BAEL">BAEL</option>';
	$data = $data .'<option value="BSCRIM">BSCRIM</option>';
